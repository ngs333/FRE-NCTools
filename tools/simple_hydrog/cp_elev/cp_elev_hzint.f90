...
character(len=*), parameter :: namelist_file_fp = "./cp_elev_namelist.nml"
...
subroutine read_namelist(file_path, ntiles, ide, jde, rese,ido, jdo, ncell_cnv, reso)
  ...
  !! Namelist definition.
  namelist /EXAMPLE/ ntiles, ide, jde, rese,ido, jdo, ncell_cnv, reso
  ...
  if (rc /= 0) write (6, '("Error: invalid Namelist format")')
