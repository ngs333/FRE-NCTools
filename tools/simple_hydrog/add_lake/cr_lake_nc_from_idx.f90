...
real :: pi, dtr, sum, mval_in, lf
character(len=8)   :: var
character(len=40)  :: var_units, latlon_var
character(len=100) :: fname, latlon_nc_file
...
real, allocatable, dimension (:,:)      :: lake_var, lake_code
